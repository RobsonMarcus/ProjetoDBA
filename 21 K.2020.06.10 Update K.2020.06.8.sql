...
BEGIN TRANSACTION
GO
PRINT N'Altering [dbo].[unidade_parametro_relatorio]...';


GO
ALTER TABLE [dbo].[unidade_parametro_relatorio]
    ADD [logo2] IMAGE NULL;
...
GO
PRINT N'Altering [dbo].[unidade_parametro_relatorio_lab]...';


GO
ALTER TABLE [dbo].[unidade_parametro_relatorio_lab]
    ADD [logo2] IMAGE NULL;
...
GO
PRINT N'Creating [dbo].[FCN_FORMATA_IN]...';
...
GO
PRINT N'Altering [dbo].[ksp_Unidade_Parametro_Relatorio]...';


GO
ALTER PROCEDURE [dbo].[ksp_Unidade_Parametro_Relatorio]
@opcao INT, @unidcodigo CHAR (4), @cabecalhoreport1 VARCHAR (100)=null, @cabecalhoreport2 VARCHAR (100)=null, @cabecalhoreport3 VARCHAR (100)=null
AS
if @opcao = 0
begin
	...
	from unidade_parametro_relatorio
	where unid_codigo =  isnull(@unidcodigo, unid_codigo)
end

if @opcao = 1
begin
	insert into unidade_parametro_relatorio ( 	unid_codigo,
							cabecalho_report1,
							cabecalho_report2,
							cabecalho_report3	)
...
if @opcao = 2
begin
	update	unidade_parametro_relatorio 
	set	cabecalho_report1 = @cabecalhoreport1, 
		cabecalho_report2 = @cabecalhoreport2,
		cabecalho_report3 = @cabecalhoreport3
	where	unid_codigo = @unidcodigo
end
GO
IF @@ERROR <> 0
   AND @@TRANCOUNT > 0
...
GO
PRINT N'Altering [dbo].[ksp_Internacao]...';
...
GO
PRINT N'Refreshing [dbo].[ksp_Administracao_Municipio_Populacao]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Administracao_Municipio_Populacao]';
...
GO
PRINT N'Refreshing [dbo].[ksp_estatistica_upa_diagnostico_top20]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_estatistica_upa_diagnostico_top20]';
...
GO
PRINT N'Refreshing [dbo].[ksp_Pezinho_Estatistica_Fenilcetonuria]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Pezinho_Estatistica_Fenilcetonuria]';
...
GO
PRINT N'Refreshing [dbo].[ksp_Pezinho_Estatistica_Hipotireoidismo]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Pezinho_Estatistica_Hipotireoidismo]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_apac_previsao_faturamento]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_apac_previsao_faturamento]';
...
GO
PRINT N'Refreshing [dbo].[ksp_Relatorio_Central_Boleto]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Relatorio_Central_Boleto]';
...
GO
PRINT N'Refreshing [dbo].[ksp_Relatorio_Encaminhamento_Pacientes]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Relatorio_Encaminhamento_Pacientes]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_Estatistica_Consolidado_Unidade_Referenciada]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_Estatistica_Consolidado_Unidade_Referenciada]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_estatistica_diaria_internacao]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_estatistica_diaria_internacao]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_estatistica_leitos_operacionais]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_estatistica_leitos_operacionais]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_motivo_saida_diario]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_motivo_saida_diario]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_movimentacao_diaria]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_movimentacao_diaria]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_movimentacao_mensal_censo]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_movimentacao_mensal_censo]';
...
GO
PRINT N'Refreshing [dbo].[ksp_Relatorio_Orientacao_Pacientes]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Relatorio_Orientacao_Pacientes]';
...
GO
PRINT N'Refreshing [dbo].[ksp_Relatorio_Pezinho_Sedex_Postagem_Correios]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Relatorio_Pezinho_Sedex_Postagem_Correios]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_radiologia_agenda_central_sub1]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_radiologia_agenda_central_sub1]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_situacao_leitos]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_situacao_leitos]';
...
GO
PRINT N'Refreshing [dbo].[ksp_CNES_unidade]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_CNES_unidade]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_Coleta_Exames]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_Coleta_Exames]';
...
GO
PRINT N'Refreshing [dbo].[ksp_relatorio_laboratorio_labexterno]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_relatorio_laboratorio_labexterno]';
...
GO
PRINT N'Refreshing [dbo].[ksp_Unidade_Parametro_Relatorio_Lab]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ksp_Unidade_Parametro_Relatorio_Lab]';
...
GO
PRINT N'Droping [dbo].[ksp_Pacientes_Observacao]...';
GO

ALTER TABLE [dbo].[Atendimento] DROP CONSTRAINT [ATENDIMENTO_LOCALATENDIMENTO_RFK]
GO
IF @@ERROR <> 0
   AND @@TRANCOUNT > 0
    BEGIN
